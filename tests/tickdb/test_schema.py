...
def test_guild_config__repr__(session, f_guild_configs, f_tickets):
    expect = "GuildConfig(id=1111, support_channel_id=1, category_channel_id=10, log_channel_id=2, role_id=3, adult_role_id=8, practice_channel_id=None, practice_role_id=None, practice_pin_id=None)"
